...
dial_on()
{
    ...
    if [ $pppd_stat -gt 0 ];then
        ...
        #ppp start  
        pppd modem /dev/ttyS1 115200 nocrtscts lock connect "chat -v -f /etc/ppp/gprs-chat" user "" noauth debug defaultroute  
            # pppd配置说明：  
