 ...
 */
static struct timer_list TxNextPacketTimer;
 ...
 */
//static struct timer_list Led1Timer;

/*!
 * Timer to handle the state of LED2
 */
//static struct timer_list Led2Timer;
        ...
        case 224:
            ...
            else
            {
                ...
                case 4: // (vii)
                    ...
                    AppData[0] = 4;
                    for( i = 1; i < MIN( AppDataSize, LORAWAN_APP_DATA_MAX_SIZE ); i++ )
                    {
...
int Radio_routin(void *data){
    ...
    #error "Please define a region in the compiler options."
#endif
                /*init_timer( &TxNextPacketTimer, OnTxNextPacketTimerEvent );
