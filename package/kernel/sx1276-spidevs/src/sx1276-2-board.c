...
{
    gpio_request(SX1278_2_RST_PIN, "SX1278_2_RST_PIN");
    ...
    gpio_direction_input(SX1278_2_DIO2_PIN);
...
void sx1276_2IoIrqInit( DioIrqHandler **irqHandlers )
{
    ...
    if(err)
    {
        printk(KERN_WARNING "sx1278_2_dio0irq request failed\r\n");
    }
    ...
    if(err)
    {
        printk(KERN_WARNING "sx1278_2_dio1irq request failed\r\n");
    }
    ...
    if(err)
    {
        printk(KERN_WARNING "sx1278_2_dio2irq request failed\r\n");
    }
    ...
    if(err)
    {
        printk(KERN_WARNING "sx1278_2_dio3irq request failed\r\n");
    }
    ...
    if(err)
    {
        printk(KERN_WARNING "sx1278_2_dio4irq request failed\r\n");
    }
    ...
    //if(err)
    //{
        //printk(KERN_WARNING "sx1278_2_dio5irq request failed\r\n");
    //}
}
