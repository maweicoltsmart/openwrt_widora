...
*/
#ifndef __sx1276_2_H__
#define __sx1276_2_H__
#include "typedef.h"
 ...
 *         all interrupts.
 *         After calling this function either sx1276_2SetRxConfig or
 *         sx1276_2SetTxConfig functions must be called.
 *
